...
public class RetrofitConfiguration {
    ...
    @Bean
    public OkHttpClient secureKeyClient(@Value("${service.security.key-username}") String secureKeyUsername,
                                        @Value("${service.security.key-password}") String secureKeyPassword)
    {
